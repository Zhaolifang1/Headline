...
import com.example.headline.bean.XFBean;
...
public class XunfeiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //找到控件
        edit_query = (EditText) findViewById(R.id.edit_xunfei);
        shibie = (Button) findViewById(R.id.shibie);
        hecheng = (Button) findViewById(R.id.hecheng);
        //语音识别的监听
        shibie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RecognizerDialog mDialog = new RecognizerDialog(XunfeiActivity.this, null);
...
//回答对象,在没有匹配到用户说的话,默认输出语句
                            ...
                            if (result.contains("你好")) {
                                ...
                                anwser = "和小明一块玩";
                            } else if (result.contains("谁最美？")) {
//定义一个String数组,智能语音根据美女这个数据,可能说的话
                                String[] answerList = new String[]{"当然是您了", "您是世界上最美的"};
...
//4.显示dialog，接收语音输入
        ...
        hecheng.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String string = edit_query.getText().toString();
                shuo(string);
            }
        });
    }

    private void shuo(String result) {
...
//参数1 String类型的json数据 参数2.存放json数据对应的bean类
        XFBean
                xfBean = gson.fromJson(resultString, XFBean.class);
//创建集合,用来存放bean类里的对象
